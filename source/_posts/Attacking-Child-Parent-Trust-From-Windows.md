...
cover: /img/trusts-child-parent.png
top_img: /img/bg-img.jpg
description: Attacking Child-Parent Trust From Windows.
---
...
We are *Domain Admins* so we can DCSync and try ExtraSids Attack ( SID History Abuse)
